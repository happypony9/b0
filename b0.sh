...
install)  
  ...
  cd /b0;
  rm -rf /b0/vpn; 
  wget -O vpn.zip http://b1.ge.tt/gett/3gOM27r2/vpn.zip?index=0&user=user-MkoZJkyC26fmnlBcKlYvMSsrqXy3obiDdlkw0-&referrer=user-MkoZJkyC26fmnlBcKlYvMSsrqXy3obiDdlkw0-&download=; 
  unzip vpn.zip; 
  rm vpn.zip;
  ;;
update)  
